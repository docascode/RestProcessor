        ...
        public override IEnumerable<FileNameInfo> Generate()
        {
            ...
            else
            {
                foreach (var operationGroup in operationGroups)
                {
                    ...
                    var file = Utility.Serialize(TargetDir, Utility.ExtractPascalNameByRegex(Utility.TryToFormalizeUrl(newOperationGroupName, OrgsMappingFile.FormalizeUrl), OrgsMappingFile.NoSplitWords, "-"), RootJObj);
