namespace Microsoft.RestApi.RestCI
{
    ...
    public class Program
    {
        ...
        private static List<FileNameInfo> MergeRestFile(List<FileNameInfo> splitedGroupFiles, List<FileNameInfo> fileNameInfos, RestFileInfo restFileInfo)
        {
            ...
            {
                var existFinleNameInfo= set.Where(fileNameInfo=> fileNameInfo.TocName== item.TocName && restFileInfo.TocTitle== fileNameInfo.ServiceInfo.TocTitle).FirstOrDefault();
