    ...
    public class OrgsMappingProcessor : MappingProcessorBase
    {
        ...
        private static void WriteToc(string sourceRootDir, string targetRootDir, OrgsMappingFile orgsMappingFile)
        {
            ...
            using (var writer = new StreamWriter(targetTocPath))
            {
                ...
                if (orgsMappingFile.AutoGenerateApisPage)
                {
                    var targetIndexPath = Path.Combine(targetRootDir, Constants.AutoGeneratedPage.TargetFileName);
                ...
                foreach (var orgInfo in orgsMappingFile.OrgInfos)
                {
                    ...
                    else if(!orgsMappingFile.AutoGenerateApisPage && !string.IsNullOrEmpty(orgInfo.DefaultTocTitle) && !string.IsNullOrEmpty(orgInfo.OrgIndex))
                    {
